...
<!--<div id="wrapper" class="container">-->
    ...
    <!-- Questa immagine rompe tutto su mozzilla -->
        ...
        <h5> Nel caso volessi organizzare eventi nel sito contatta l'amministratore alla mail <a href="mailto:admin@r3stickets.it?subject=Richiesta nuovo organizzatore.&body=Salve con la presente chiedo maggiori informazioni sul ruolo di organizzatore all'interno del sito."> admin@r3stickets.it </a></h5>
        </div>
    </section>
<!--</div>-->
@endsection 