    ...
    <div class="center">
        ...
        <div class="container-contact">
            <div class="wrap-contact1">
                <form class="contact-form" enctype="multipart/form-data" type="post">
                    @csrf
                    ...
                    <span class="container-form-btn">
                        @if(isset($event))
                        <button type="submit" name="modifica" id="modifica" class="button clickable"
                                type="post", 
                                formaction="{{route('storeModifiedEvent',[$event->id])}}">Conferma Modifica</button>
                        @else
                        <button type="submit" name="conferma" id="conferma" class="button clickable"
                                type="post", 
